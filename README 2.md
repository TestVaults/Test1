...
| Open | Completed (click the checkbox) |
|---|---|
| ![Task embed showing an open task](screenshots/task-embed-open.png) | ![Task embed after clicking the checkbox — struck through and marked complete](screenshots/task-embed-completed.png) |
...
| Before | After |
|---|---|
| ![Asana task list before creating the task from Obsidian](screenshots/asana-before.png) | ![Asana task list after — the new task created from Obsidian now appears](screenshots/asana-after.png) |
